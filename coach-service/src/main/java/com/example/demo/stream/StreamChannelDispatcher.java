...
public class StreamChannelDispatcher {
    ...
    public StreamChannelDispatcher(CoachStream coachStream) {
    ...
    private MessageChannel fetchChannel(String channelName) throws InvocationTargetException, IllegalAccessException {
        Method method = Arrays.stream(CoachStream.class.getDeclaredMethods())
        ...
        return (MessageChannel) method.invoke(this.coachStream);
    }
}
